...
const SystemStatus = () => {
    return (
        <div className="flex flex-col gap-8 h-full">
            <div className="glass-card border-border rounded-[32px] p-8">
                <h3 className="text-text-primary text-xs font-black uppercase tracking-[0.3em] mb-8 flex items-center gap-2">
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between text-xs font-bold">
                        ...
                        <span className="flex items-center gap-2 text-emerald-500">
                            <span className="size-1.5 rounded-full bg-emerald-500 animate-pulse"></span> SYNCED
                        </span>
                    </div>
                    <div className="flex items-center justify-between text-xs font-bold">
                ...
                <div className="mt-8 pt-6 border-t border-border flex flex-col gap-1">
                    <div className="text-[10px] text-text-muted font-black uppercase tracking-widest">Est. Response Lag</div>
                    <div className="text-text-primary font-mono text-xl font-black italic tracking-tighter">
            ...
            <div className="glass-card border-border rounded-[32px] p-8 flex-1 flex flex-col">
                <h3 className="text-text-primary text-xs font-black uppercase tracking-[0.3em] mb-8 flex items-center gap-2 italic">
                ...
                <div className="flex flex-col gap-4 flex-1">
                    {[
                        ...
                        <details key={idx} className="group">
                            <summary className="flex cursor-pointer items-center justify-between rounded-xl bg-primary/5 p-4 text-xs font-bold text-text-primary hover:bg-primary/10 transition-colors list-none">
                                <span>{item.q}</span>
                ...
                <div className="mt-8">
                    ...
                    <div className="space-y-4">
                        <a className="flex items-center gap-3 text-xs font-bold text-primary hover:text-text-primary transition-colors group" href="#">
