...
const Prevention = () => {
    return (
        <section className="flex flex-col gap-6" id="prevention" style={{ '--checkbox-tick-svg': "url('data:image/svg+xml,%3csvg viewBox=%270 0 16 16%27 fill=%27rgb(255,255,255)%27 xmlns=%27http://www.w3.org/2000/svg%27%3e%3cpath d=%27M12.207 4.793a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0l-2-2a1 1 0 011.414-1.414L6.5 9.086l4.293-4.293a1 1 0 011.414 0z%27/%3e%3c/svg%3e')" }}>
            ...
            <div className="rounded-xl border border-slate-200 dark:border-[#3b4754] bg-surface-light dark:bg-surface-dark p-6">
                {[
                    ...
                    <label key={idx} className="flex gap-x-4 py-3 items-start border-b border-slate-100 dark:border-slate-800 last:border-0 cursor-pointer group">
                        <input type="checkbox" className="mt-1 h-5 w-5 rounded border-slate-300 dark:border-[#3b4754] border-2 bg-transparent text-primary checked:bg-primary checked:border-primary focus:ring-0 focus:ring-offset-0 transition-all font-bold" />
