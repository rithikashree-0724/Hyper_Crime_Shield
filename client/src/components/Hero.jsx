        ...
        <section className="@container">
            <div className="relative overflow-hidden rounded-xl bg-surface-dark">
                <div
                    ...
                    style={{
                        backgroundImage: 'linear-gradient(rgba(16, 25, 34, 0.3) 0%, rgba(16, 25, 34, 0.9) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuCWOfw9tyBVtB7fUQNssKL5V09SqE775KgzWURqILMGD1rSLO7Z8dPZGAB-gmHBH2wSiAbDSjPga5lMR9n7eG_WdXFnQdhjpqzfRBaJt2RSK2KMiuD1loCISW-E6yNs5n3vxFYo2K4SKU_83wQcC6gVoXwCQ6TY1neA0C9vdFtl2RxsMnTb0wRKjee7mhFNtZJ2ylUZCfYRpPSAg6UWWlGrGvEFIqVx0LBNSFefDZWhI3X6f5-3SkJm2ot4iMrM0f-SLORBbRIacM3j")'
                    }}
                >
                    <div className="flex flex-col gap-3 text-left max-w-2xl relative z-10">
                        ...
                        <h2 className="text-slate-200 text-sm font-normal leading-relaxed md:text-base lg:text-lg">
                    ...
                    <div className="flex flex-wrap gap-4 relative z-10">
                        <button className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-primary hover:bg-blue-600 text-white text-base font-bold leading-normal tracking-[0.015em] transition-colors shadow-lg shadow-primary/30">
